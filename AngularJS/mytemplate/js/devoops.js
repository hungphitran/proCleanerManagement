...
function LoadCalendarScript(callback){
	function LoadFullCalendarScript(){
		if(!$.fn.fullCalendar){
			$.getScript('mytemplate/plugins/fullcalendar/fullcalendar.js', callback);
		}
		else {
...
function LoadSelect2Script(callback){
	if (!$.fn.select2){
		$.getScript('mytemplate/plugins/select2/select2.min.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadDataTablesScripts(callback){
	function LoadDatatables(){
		$.getScript('mytemplate/plugins/datatables/jquery.dataTables.js', function(){
			$.getScript('mytemplate/plugins/datatables/ZeroClipboard.js', function(){
				$.getScript('mytemplate/plugins/datatables/TableTools.js', function(){
					$.getScript('mytemplate/plugins/datatables/dataTables.bootstrap.js', callback);
				});
			});
		});
	}
...
function LoadFancyboxScript(callback){
	if (!$.fn.fancybox){
		$.getScript('mytemplate/plugins/fancybox/jquery.fancybox.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
